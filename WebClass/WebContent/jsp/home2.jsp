...
<link rel="stylesheet" href="/WebClass/css/master.css">
<script src="http://code.jquery.com/jquery-1.11.0.min.js"></script>
<script src="/WebClass/js/movement.js"></script>
<!-- Optional JavaScript -->
		...
		<div class="site-wrapper">
			...
			<section class="content">
				...
				<article class="inner-content">
					<img src="/WebClass/image/mypic.jpg" alt="내 사진" id="myimg">
					<h2>Introduce</h2>
					<p>안녕하세요, 저는 개발자가 되고 싶은 정윤교입니다. 앱, 웹, 임베디드에 관심이 많은 뭐든지 하고 싶고,
						잘하고 싶은 아직은 초보여서 뭐든지 미숙한 사람입니다. 사람들의 삶에 도움을 주고 편히 쓸 수 있는 서비스를 개발하는
						것이 꿈입니다</p>
				...
				<article class="inner-content">
					...
					<ul>
						<li><a
							href="https://www.facebook.com/profile.php?id=100006441255616">Facebook</a></li>
				...
				<div>
					<form id="signUpForm">
						<div id="radiobutton" class="btn-group" data-toggle="buttons">
							<label class="btn btn-primary"> <input class="radio"
								type="radio" name="grade" value="first" required>1학년
							</label> <label class="btn btn-primary"> <input class="radio"
								type="radio" name="grade" value="second">2학년
							</label> <label class="btn btn-primary"> <input class="radio"
								type="radio" name="grade" value="third">3학년
							</label>
						</div>
						...
						</select><br> 번호 : <input class="radio form-control mr-sm-2"
							placeholder="번호" type="text" name="number" value="" required><br>
						이름 : <input class="radio form-control mr-sm-2" placeholder="이름"
							type="text" id="name" name="name" value="" required><br>
